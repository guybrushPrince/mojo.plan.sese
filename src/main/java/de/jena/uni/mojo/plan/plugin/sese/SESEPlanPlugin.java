 ...
 */
package de.jena.uni.mojo.plan.plugin.sese;
...
import de.jena.uni.mojo.plan.plugin.sese.plan.SESEDecompositionMajorPlan;
...
public class SESEPlanPlugin implements PlanPlugin {
	...
	public MajorPlan getInstance(WorkflowGraph graph, WGNode[] map,
		...
		return new SESEDecompositionMajorPlan(graph, map, analysisInformation, store);
	}
